...
curl -X POST -d '{"qos_id":"all"}' http://localhost:8080/qos/rules/0000000000000001
echo "Removing Qos Rules in Switch1, Server1 to Server2 Communication"

#Removing QoS Rules for Switch1
curl -X POST -d '{"qos_id":"all"}' http://localhost:8080/qos/rules/0000000000000002
echo "Removing Qos Rules in Switch2, Server2 to Server3 Communication"

#Removing QoS Rules for Switch1
curl -X POST -d '{"qos_id":"all"}' http://localhost:8080/qos/rules/0000000000000003
